class CustomCoverCard extends HTMLElement {
    ...
    if (!this.card) {
      ...
      entities.forEach(function(entityId) {
        ...
        let mouseUp = function(event) {
          ...
          _this.updateCoverPosition(hass, entityId, 100 - percentagePosition);
  ...
  updateCoverPosition(hass, entityId, position) {
