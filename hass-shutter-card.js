class ShutterCard extends HTMLElement {
  set hass(hass) {
        ...
        shutter.innerHTML = `
          <div class="sc-shutter-left">
            ...
            <div class="sc-shutter-buttons">
              <ha-icon-button icon="mdi:arrow-up" class="sc-shutter-button" data-command="up"></ha-icon-button>
              <ha-icon-button icon="mdi:stop" class="sc-shutter-button" data-command="stop"></ha-icon-button>
              <ha-icon-button icon="mdi:arrow-down" class="sc-shutter-button" data-command="down"></ha-icon-button>
            </div>
          </div>
          <div class="sc-shutter-right">
        ...
        .sc-shutters { padding: 16px; }
          ...
          .sc-shutter:first-child { margin-top: 0; }
            .sc-shutter-left { flex: 1; }
              .sc-shutter-label { font-size: 20px; }
              .sc-shutter-buttons { text-align: center; margin-top: 2rem; }
            .sc-shutter-right { flex: 1; }
    ...
    entities.forEach(function(entity) {
      ...
      shutter.querySelector('.sc-shutter-label').innerHTML = friendlyName;
      shutter.querySelector('.sc-shutter-position').innerHTML = currentPosition + '%';
