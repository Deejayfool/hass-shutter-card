...
class Shutter extends LitElement {
  ...
  static get styles() {
    return css`
      ...
      .sc-shutter-selector-partial { position: absolute; top:0; left: 6%; width: 88%; height: 1px; background-color: gray; }
      ...
      .sc-shutter-selector-picker { position: absolute; top: 19px; left: 6%; width: 88%; cursor: pointer; height: 20px; background-size: 100% 7px; background-repeat: no-repeat; }
